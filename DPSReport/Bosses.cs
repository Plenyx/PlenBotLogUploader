    ...
    public static class Bosses
    {
        ...
        public static Dictionary<int, BossData> GetDefaultSettingsForBossesAsDictionary()
        {
            return new Dictionary<int, BossData>()
            {
                ...
                { 3, new BossData() { BossId = (int)BossIds.BanditTrio, Name = "Bandit Trio", SuccessMsg = "Bandit Trio log: <log>", FailMsg = "Bandit Trio log: <log> | Wipe counter: <pulls>", Icon = "https://i.imgur.com/UZZQUdf.png", Type = BossType.Raid, Event = true } },
