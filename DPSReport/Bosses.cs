...
namespace PlenBotLogUploader.DPSReport
{
    public static class Bosses
    {
        public static Dictionary<int, BossData> GetDefaultSettingsForBossesAsDictionary()
        {
            ...
            {
                { 1, new BossData() { BossId = (int)BossIds.Arkk, Name = "Arkk" } },
                { 2, new BossData() { BossId = (int)BossIds.Artsariiv, Name = "Artsariiv" } },
                { 3, new BossData() { BossId = (int)BossIds.BanditTrio, Name = "Bandit Trio", SuccessMsg = "Bandit Trio log", FailMsg = "Bandit Trio log", Icon = "https://i.imgur.com/UZZQUdf.png" } },
                { 4, new BossData() { BossId = (int)BossIds.BrokenKing, Name = "Broken King" } },
