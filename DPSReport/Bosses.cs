    ...
    public static class Bosses
    {
        public static Dictionary<int, BossData> GetDefaultSettingsForBossesAsDictionary()
        {
            return new Dictionary<int, BossData>()
            {
                ...
                { 6, new BossData((int)BossIds.CardinalAdina, "Cardinal Adina") },
                { 7, new BossData((int)BossIds.CardinalSabir, "Cardinal Sabir") },
                ...
                { 23, new BossData((int)BossIds.QadimThePeerless, "Qadim the Peerless")},
