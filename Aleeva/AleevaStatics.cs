        ...
        internal static async Task GetAleevaTokenFromRefreshToken(FormMain mainLink, HttpClientController controller)
        {
            ...
            try
            {
                ...
                if (responseToken.IsSuccess)
                {
                    ...
                    controller.DefaultRequestHeaders.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", ApplicationSettings.Current.Aleeva.AccessToken);
