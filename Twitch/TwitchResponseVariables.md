...
| `%spotifySong%` | r.94            | The currently playing song on Spotify (available only under Windows)                                                                                                  |
| `%gw2Ign%`      | r.94            | Returns the In-Game account Name for the currently played character. Requires MumbleLink setup and inserted appropriate GW2 API keys (available only under Windows)   |
| `%gw2Build%`    | r.94            | Returns the currently played build for the currently played character. Requires MumbleLink setup and inserted appropriate GW2 API keys (available only under Windows) |
